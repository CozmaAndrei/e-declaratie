...
class ReportUserForm(forms.Form):
    ...
    description = forms.CharField(label="Descrierea raportului", widget=forms.Textarea(attrs={'class': 'form-control', 'rows': 5, 'placeholder': 'Vă rugăm să furnizați o descriere detaliată a problemei'}))