...
def edited_text(edit_text, company_id, invoice_number, invoice_date):
...
def preview_edit_pdf(request, company_id):
    ...
    # Write the text
    content = edited_text(text_lines, company_id, invoice_number, new_formatted_invoice_date)
    c.setFont("Helvetica", 12)
